...
-- This view counts the number of customers in each city.
CREATE VIEW CustomerCityCount AS
SELECT a.City, COUNT(c.CustomerID) AS CustomerCount
FROM Customer c
...
SELECT CategoryID, CategoryName, TotalQuantitySold FROM
