...
INSERT INTO ProvinceTable (ProvinceID, Province, City)
VALUES (1, 'Ontario', 'Toronto');

INSERT INTO ProvinceTable (ProvinceID, Province, City)
VALUES (2, 'New York', 'New York');

INSERT INTO ProvinceTable (ProvinceID, Province, City)
VALUES (3, 'California', 'Los Angeles');

INSERT INTO ProvinceTable (ProvinceID, Province, City)
VALUES (4, 'Illinois', 'Chicago');

INSERT INTO ProvinceTable (ProvinceID, Province, City)
VALUES (5, 'Texas', 'Houston');

-- Insert data into the Country table

INSERT INTO CountryTable (CountryID, Country, PostalCode, ProvinceID)
VALUES (1, 'Canada', 'P7H0A8', 1);

INSERT INTO CountryTable (CountryID, Country, PostalCode, ProvinceID)
VALUES (2, 'USA', '10001', 2);

INSERT INTO CountryTable (CountryID, Country, PostalCode, ProvinceID)
VALUES (3, 'USA', '90001', 3);

INSERT INTO CountryTable (CountryID, Country, PostalCode, ProvinceID)
VALUES (4, 'USA', '60601', 4);

INSERT INTO CountryTable (CountryID, Country, PostalCode, ProvinceID)
VALUES (5, 'USA', '77001', 5);

INSERT INTO CountryTable (CountryID, Country, PostalCode, ProvinceID)
VALUES (6, 'Canada', 'M1Z001', 1);

INSERT INTO CountryTable (CountryID, Country, PostalCode, ProvinceID)
VALUES (7, 'USA', '90101', 2);

-- Insert data into the Address table
INSERT INTO Address (AddressID, StreetNumber, StreetName, CountryID)
VALUES (1, '123', 'Main St', 1);

INSERT INTO Address (AddressID, StreetNumber, StreetName, CountryID)
VALUES (2, '456', 'Oak Avenue', 2);

INSERT INTO Address (AddressID, StreetNumber, StreetName, CountryID)
VALUES (3, '789', 'Cedar Lane', 3);

INSERT INTO Address (AddressID, StreetNumber, StreetName, CountryID)
VALUES (4, '1010', 'Maple Street', 4);

INSERT INTO Address (AddressID, StreetNumber, StreetName, CountryID)
VALUES (5, '234', 'Pine Avenue', 5);

INSERT INTO Address (AddressID, StreetNumber, StreetName, CountryID)
VALUES (6, '134', 'Brooke Road',1);

INSERT INTO Address (AddressID, StreetNumber, StreetName, CountryID)
VALUES (7, '134', 'Brooklyn Street', 2);
